# Статус проекта GamingBlog

Дата: 24 апреля 2026
Автор: фронт-часть команды (dboev.dev@gmail.com)
Для: бэк-часть команды (коллега)
...
## Вопросы ко мне — где писать

Любой вопрос — пиши мне в обычный наш канал (Discord / Telegram / что у нас). Если по коду — открывай issue на GitHub, или сразу пиши в PR-ревью, когда запушусь.

Если что-то из фронта кажется лишним или нужно что-то убрать — говори, отформачу без проблем.
